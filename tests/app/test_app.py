...
from flango.flango import Flango, _Stack
from flango.router import RouterException
...
def push_session():
    app.session['flango'] = "a web framework"
    return app.session['flango'].value
...
class AppTest(unittest.TestCase):
    ...
    def test_500_internal_error(self):
        ...
        r = app(env, start_response)
        self.assertEqual('500 Internal Server Error', app._response.status)
